...
O mezuro standalone surgiu da necessidade 
Retirar do noosfero devido à limitação da comunidade, noosfero desenvolvido a versão do rails antiga com pouco suporte pela comunidade e limitado as funções dessa versão
Portado para um plataforma independente baseada no framework rails 4.0.
Design BootStrap
Protocolo comunicação atual SOAP entre mezuro e kalibro porém possível mudança JSON.
